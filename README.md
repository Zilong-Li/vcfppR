...
This example shows how to read only SNP variants with GT format in the
VCF/BCF into R tables: The URL link to the 1000 Genome Project can be
directly fed to vcfppR.
...
This example shows how to read only SNP variants with PL format in the
...
res <- vcftable(vcffile, "chr21:1-5100000", vartype = "snps", format = "PL")
str(res)
```

This example shows how to read only indels variants with AD format in
the VCF/BCF into R tables:

``` r
vcffile <- "https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1000G_2504_high_coverage/working/20201028_3202_raw_GT_with_annot/20201028_CCDG_14151_B01_GRM_WGS_2020-08-05_chr21.recalibrated_variants.vcf.gz"
res <- vcftable(vcffile, "chr21:1-5100000", vartype = "indels", format = "AD")
str(res)
```
...
discovered by GATK-SV. The data is from the 1000 Genome Project.
