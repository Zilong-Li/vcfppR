...
This example shows how to read only SNP variants with GT format in the VCF/BCF into R tables: The URL link to the 1000 Genome Project can be directly fed to vcfppR. 
```r
library(vcfppR)
...
This example shows how to read only SNP variants with PL format in the VCF/BCF into R tables:
...
This example shows how to read only indels variants with AD format in the VCF/BCF into R tables:
...
This example shows how to summarize complex structure variants discovered by GATK-SV. The data is from the 1000 Genome Project. 
